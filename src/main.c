...
#define CHANNEL_CARRIER     (107.7 * 1000000)   // 100.1 MHz - FM channel center frequency
...
#define SQUELCH_LEVEL       -80     // -60 dBFS
...
uint8_t stereo_audio_demod(int16_t sBaseband, int16_t sStereoPilot, int16_t *psLeft, int16_t *psRight)
{
    ...
    sMonoAudio *= 0.7; // Attenuate to increase stereo ratio
